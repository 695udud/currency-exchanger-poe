// src/components/ui/PrecosDashboard.jsx
      ...
      <div className="bg-white shadow p-6 rounded-xl mb-6">
        ...
        <div className="grid grid-cols-2 gap-4 mb-4">
          <div>
            ...
            <input type="number" value={buyDiv} onChange={(e) => setBuyDiv(e.target.value)} className="border p-2 w-full rounded" />
          </div>
          <div>
            <label className="font-semibold">Venda (Divine)</label>
            <input type="number" value={sellDiv} onChange={(e) => setSellDiv(e.target.value)} className="border p-2 w-full rounded" />
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 gap-4 mb-4">
          <div>
            ...
            <input type="number" value={buyCh} onChange={(e) => setBuyCh(e.target.value)} className="border p-2 w-full rounded" />
          </div>
          <div>
            <label className="font-semibold">Venda (Chaos)</label>
            <input type="number" value={sellCh} onChange={(e) => setSellCh(e.target.value)} className="border p-2 w-full rounded" />
          </div>
        </div>
